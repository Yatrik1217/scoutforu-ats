...
export default async function AnalyticsPage() {
  ...
  const kpis = [
    { label: "Offer Accept Rate", value: `${offerAcceptRate(ws.candidates)}%`, delta: "+5% vs last qtr", tone: "pos" },
    { label: "Avg Time-to-Hire", value: tth ? `${tth}d` : "—", delta: "-3d faster", tone: "pos" },
    { label: "Pipeline Velocity", value: `${velAvg}d`, delta: "per stage", tone: "neutral" },
    { label: "Total Hires (QTD)", value: stageCount(ws.candidates, "Joined"), delta: "+17%", tone: "pos" },
  ] as const;
      ...
      <div className="grid grid-cols-2 gap-[18px]">
        ...
        <div className="rounded-2xl border border-[#e9edf3] bg-white p-[22px]">
          ...
          {PIPELINE_STAGES.map((s, i) => (
            <div key={s.key} className="mb-[11px] flex items-center gap-3">
