...
export default async function GeneralSettingsPage() {
  ...
  const tiles: Tile[] = [
    { title: "Organization", subtitle: "Details & branches", desc: "Company name, logo, address, branding and your branches / units — all in one place.", icon: Building2, color: "#e8833a", href: "/admin/settings/organization" },
    ...
    { title: "Working Hours", subtitle: "Standard shift", desc: "Shift start/end (e.g. 10:00–19:00), grace period and full/half-day thresholds used to flag late arrivals.", icon: Clock, color: "#e8833a", href: "/admin/settings/attendance" },
